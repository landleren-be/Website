...
captureButton.addEventListener('click', function() {
    ...
    var modelURL = 'https://teachablemachine.withgoogle.com/models/006P3gJhZ/';
    var model;
...
// Array met 9 landen
const landen = ['Frankrijk', 'Luxemburg', 'Polen', 'Finland', 'Zweden', 'Hongarije', 'Letland', 'Slowakije', 'Griekenland'];
//
