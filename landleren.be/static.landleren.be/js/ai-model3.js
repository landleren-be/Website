...
captureButton.addEventListener('click', function() {
    ...
    var modelURL = 'https://teachablemachine.withgoogle.com/models/cnOAzycTq/';
    var model;
...
// Array met 9 landen
const landen = ['Tsjechie', 'Spanje', 'Slovenie', 'Roemenie', 'Portugal', 'Malta', 'Nederland', 'Litouwen', 'Ierland'];
//
