...
const imgLink = "https://static.landleren.be/flag/name/"; // linkt to the folder containing the flags - these are stored on a different server to improve performance and loading times
